<%-- 
    Document   : welcome
    Created on : Nov 19, 2022, 5:46:37 PM
    Author     : paige
--%>
...
<html>
    ...
    <body>
        <div id ="Nav-bar">
            ...
            <div id="username_cart">
                <%
                    ...
                    if(username == null){
                        out.print("<a href=\"login.jsp\" id=\"login_button\">Log in</a>");
                        //Signup.jsp is waiting for approval
                        //out.print("<a href=\"signup.jsp\">Sign up</a>");
                    }
                    else{
                       out.print("<h1> Hello " + username + "</h1>");
                       out.print("<a href=\"shppingcart.jsp\"><i class=\"fa fa-shopping-cart\" style=\"font-size:36px\"></i></a>");
                       out.print("<form action=\"LogoutSession\">"); 
        ...
        <h4>TODO: Shopping list items will be shown here</h4>
