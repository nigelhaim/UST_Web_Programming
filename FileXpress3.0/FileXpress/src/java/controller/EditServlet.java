...
public class EditServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>EditServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    /**
     * This method will edit the description of the entry located in
     * the .txt file.
     */
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            // Clears the .txt file and writes the new description
            try
            {
                ...
                // then it forwards back to the ShowEntry servlet using the RequestDispatcher.forward()
